...
extra_snap_folders = ["snaps4"]         # list of additional snapshot folders to measure intensity 
                                # in additional channels
ocnames = ["JFX549"]                    # list of whatever names you want to call the channels
                                # corresponding to the additional snapshots
nd2folder = "smt"               # Folder containing nd2 movies.
#######################################################################################
